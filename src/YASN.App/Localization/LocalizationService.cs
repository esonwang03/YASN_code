        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Catalog =
            new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
            {
                ["en"] = new Dictionary<string, string>(StringComparer.Ordinal)
                {
                    ...
                    ["Settings.Attachments"] = "File Attachments",
                    ["Settings.Attachments.Toggle"] = "Copy file attachments into the note",
                    ["Settings.Attachments.Toggle.Description"] = "When on, files at or under the threshold are copied; larger files are linked in place.",
                    ["Settings.Attachments.Threshold"] = "Copy/link threshold (MB)",
                    ...
                    ["Settings.Editor.MinWidth"] = "Minimum note width (px)",
                    ["Settings.Editor.MinWidth.Description"] = "The narrowest a note window can be resized. Also the lower bound QuickLayout and the text+preview split clamp to.",
                    ["Settings.Editor.PreviewDoubleClick"] = "Double-click preview action",
                    ["Settings.Editor.PreviewDoubleClick.Description"] = "What happens when you double-click the preview.",
                    ["Settings.Editor.PreviewDoubleClick.None"] = "Do nothing",
                    ["Settings.Editor.PreviewDoubleClick.InApp"] = "Enter in-app editor",
                    ["Settings.Editor.PreviewDoubleClick.External"] = "Open external editor",
                    ["Settings.Log.MaxSize"] = "Log size limit (KB)",
                ...
                ["zh-CN"] = new Dictionary<string, string>(StringComparer.Ordinal)
                {
                    ...
                    ["Settings.Attachments"] = "文件附件设置",
                    ["Settings.Attachments.Toggle"] = "将文件附件复制到YASN的存储",
                    ["Settings.Attachments.Toggle.Description"] = "当启用时，所有小于复制阈值的文件都将被拷贝，大于阈值的将会被链接。",
                    ["Settings.Attachments.Threshold"] = "使用复制的阈值(MB)",
                    ["Settings.Browse"] = "浏览…",
                    ...
                    ["Settings.Editor.MinWidth"] = "便签窗口最小宽度 (px)",
                    ["Settings.Editor.MinWidth.Description"] = "便签窗口可调整的最小宽度。此外，还是快速布局以及文本+预览分割的下限宽度。",
                    ["Settings.Editor.PreviewDoubleClick"] = "双击预览的行为",
                    ["Settings.Editor.PreviewDoubleClick.Description"] = "双击预览区域时执行的操作。",
                    ["Settings.Editor.PreviewDoubleClick.None"] = "不执行任何操作",
                    ["Settings.Editor.PreviewDoubleClick.InApp"] = "进入应用内编辑器",
                    ["Settings.Editor.PreviewDoubleClick.External"] = "打开外部编辑器",
                    ["Settings.Log.MaxSize"] = "日志大小限制 (KB)",
